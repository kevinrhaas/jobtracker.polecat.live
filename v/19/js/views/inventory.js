...
export function renderInventory(view, ctx, params){
  ...
  function cell(job, col){
    if(col === 'rush') return rushCell(job);
    if(EDITABLE[col]) return editableCell(job, col, displayNode(job, col));
    return el('td',{}, displayNode(job, col));
  }
  ...
  function rushCell(job){
    const td = el('td',{class:'cell-editable', tabindex:'0', role:'button',
  ...
  function editableCell(job, col, display){
    const td = el('td',{class:'cell-editable', tabindex:'0', role:'button',
