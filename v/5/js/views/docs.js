...
function topics(){ return [
  ...
  { id:'managing-jobs', group:'user', title:'Managing jobs', icon:'edit', html:`
    ...
    <ul>
      ...
      <li><b>Comments</b> — a running discussion thread; every comment is timestamped and attributed.</li>
      <li><b>Approvals</b> — request review, then mark <em>Approved</em> or <em>Changes requested</em>. Each round is logged.</li>
  ...
  { id:'views-filters', group:'user', title:'Views, filters & export', icon:'list', html:`
    ...
    <h3>Three ways to look at work</h3>
    <ul>
  ...
  { id:'shortcuts', group:'user', title:'Tips & shortcuts', icon:'bolt', html:`
    ...
    <table class="kbd-tbl">
      ...
      <tr><td><kbd>Ctrl</kbd>/<kbd>Cmd</kbd> + <kbd>K</kbd></td><td>Open search (same as <kbd>/</kbd>)</td></tr>
  ...
  { id:'architecture', group:'dev', title:'Architecture overview', icon:'layers', html:`
    ...
    <ul>
      <li><span class="mono">app.js</span> — boot, the invite gate, hash routing, the top bar, and global glue. Hands every view a <span class="mono">ctx</span> object (<span class="mono">go</span>, <span class="mono">refresh</span>, <span class="mono">newJob</span>, <span class="mono">openJob</span>, <span class="mono">toast</span>).</li>
  ...
  milestones:[], approval:{state,rounds:[]}, icon,
  createdAt, updatedAt, createdBy, updatedBy }</code></pre>
    ...
    on write. The schema is versioned (<span class="mono">SCHEMA = 3</span>).</p>` },
