...
const GROUPS = [
  ...
  { title:'Edit', keys:[
    [['Q'], 'Quick add a job from plain text'],
    [['⌘/Ctrl','Z'], 'Undo'],
    [['⌘/Ctrl','Shift','Z'], 'Redo'],
  ...
  { title:'Board', keys:[
    [['↑','↓'], 'Focus the next/previous card in a column'],
    [['←','→'], 'Focus a card in the adjacent column'],
    [['Shift','←/→'], 'Move the focused card to that adjacent status'],
  ]},
  { title:'Help', keys:[
    [['?'], 'This shortcut sheet'],
  ]},
