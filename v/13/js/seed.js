...
// (see Store.isTransitionAllowed).
export const DEFAULT_META = {
  statuses: [
    { name:'Requested',   color:'#8b5cf6', order:1, terminal:false, ageDays:3,  allowedNext:['In Progress','On Hold','Canceled'] },
    { name:'In Progress', color:'#3b82f6', order:2, terminal:false, ageDays:10, allowedNext:['In Review','On Hold','Canceled'] },
    { name:'In Review',   color:'#f59e0b', order:3, terminal:false, ageDays:5,  allowedNext:['Approved','Revisions','On Hold'] },
    { name:'Revisions',   color:'#ec4899', order:4, terminal:false, ageDays:5,  allowedNext:['In Review','On Hold'] },
    { name:'Approved',    color:'#10b981', order:5, terminal:false, ageDays:7,  allowedNext:['Print Production','Completed','On Hold'] },
    { name:'Print Production', color:'#06b6d4', order:6, terminal:false, ageDays:14, allowedNext:['Completed','On Hold'] },
    { name:'Completed',   color:'#22c55e', order:7, terminal:true,  ageDays:0,  allowedNext:[] },
    { name:'On Hold',     color:'#94a3b8', order:8, terminal:false, ageDays:30, allowedNext:['Requested','In Progress','In Review','Canceled'] },
    { name:'Canceled',    color:'#ef4444', order:9, terminal:true,  ageDays:0,  allowedNext:[] },
  ],
  types: [
