...
const STEPS = [
  { sel:'.rail-item[data-sec="home"]',      title:'Your Dashboard', body:'Recent jobs, favorites, and live KPIs land here — your daily starting point.' },
  { sel:'.rail-item[data-sec="inventory"]', title:'Jobs Inventory', body:'Filter with pills, save custom views, bulk-edit, and export to CSV/Excel/JSON.' },
  { sel:'.rail-item[data-sec="board"]',     title:'Board & Calendar', body:'Drag jobs across statuses on the Kanban board, or see due dates on the calendar.' },
  { sel:'.topbar-search',                   title:'Search anything', body:'Press / anytime to jump to a job by number, name, client, or status.' },
  { sel:'.rail-item[data-sec="import"]',    title:'Import your data', body:'Bring in the Excel/CSV/JSON export or Microsoft Forms responses with a guided wizard.' },
  { sel:'.rail-item[data-sec="settings"]',  title:'Make it yours', body:'Manage pick lists, team members, themes, credentials, and restart this tour anytime.' },
];
